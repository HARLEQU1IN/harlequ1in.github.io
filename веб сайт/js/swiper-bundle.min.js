!function(e, t) {
    ...
    function q() {
        ...
        e.autoplay && e.autoplay.running && e.autoplay.paused && (clearTimeout(N),
        N = setTimeout((()=>{
    ...
    const Q = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onClick = R.bind(e),
                e.onLoad = V.bind(e),
                F || (t.addEventListener("touchstart", W),
                F = !0),
                j(e, "on")
            },
    ...
    , function(e) {
        ...
        function u() {
            ...
            if (a = t.params.loop ? t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex : void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0,
            "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (l += a - (t.previousIndex || 0),
          ...
          , p = ()=>{
            if (l && t.params.hashNavigation.enabled)
                if (t.params.hashNavigation.replaceState && d.history && d.history.replaceState)
                    d.history.replaceState(null, null, `#${t.slides[t.activeIndex].getAttribute("data-hash")}` || ""),
                    i("hashSet");
                else {
